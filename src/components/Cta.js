      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-white opacity-90 mb-10">
            Da el primer paso hacia el cambio que deseas ver en tu vida
          </p>
          <a href="#contacto" className="bg-white text-teal hover:bg-gray-100 font-medium py-3 px-8 rounded-lg transition duration-300 inline-block">
