    ...
    <section id="metodo" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-semibold text-darkTeal mb-4">Mi método</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-3">Exploramos tu situación actual</h3>
          ...
          <div className="p-6 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-3">Definimos objetivos</h3>
          ...
          <div className="p-6 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-3">Diseñamos un plan de acción</h3>
          ...
          <div className="p-6 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-3">Implementamos cambios</h3>
