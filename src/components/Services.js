    ...
    <section id="servicios" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-semibold text-gray-800 mb-4">Cómo puedo ayudarte</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-4 text-gray-700">Acompañamiento personalizado</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-4 text-gray-700">Estrategias para desbloquear tu potencial</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 hover:shadow-lg transition duration-300">
            ...
            <h3 className="text-2xl font-semibold mb-4 text-gray-700">Sesiones prácticas y efectivas</h3>
            <p className="text-gray-600">
