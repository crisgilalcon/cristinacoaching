      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4">
            <h3 className="accent-text mb-4" style={{ fontSize: '35px', color: 'white' }}>CristinaCoaching</h3>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="text-white text-2xl hover:text-white transition duration-300">
